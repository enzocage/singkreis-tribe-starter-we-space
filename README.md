...
* **Dezentes Tempo-Widget (80% transparent):** Frei wählbares Tempo von `0.2x` bis zu maximal `10.0x`. Das Widget dimmt sich nach 5 Sekunden automatisch auf 80% Transparenz herunter.

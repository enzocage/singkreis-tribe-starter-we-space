...
* **Dezentes Tempo-Widget (90% transparent):** Frei wählbares Tempo von `0.2x` bis zu maximal `10.0x`. Das Widget dimmt sich nach 2 Sekunden automatisch auf 90% Transparenz herunter.
